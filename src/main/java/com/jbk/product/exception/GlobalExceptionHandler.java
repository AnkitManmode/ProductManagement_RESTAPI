...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> ProductNotFoundExcep(ProductNotFoundException ex){
		return new ResponseEntity<String>(ex.getMessage(), HttpStatus.OK);

	}

	@ExceptionHandler(ProductAlreadyExist.class)
	public ResponseEntity<String> ProductAllreadyExistExcept(ProductAlreadyExist ex){
		return new ResponseEntity<String>(ex.getMessage(), HttpStatus.OK);
	}
}
